        ...
        <section className="relative overflow-hidden min-h-screen pb-8 pt-16 md:pb-16 md:pt-28 hero-gradient">
          ...
          <div className="relative mx-auto max-w-6xl px-5 md:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              {/* URL Input */}
              <div className="w-full max-w-3xl mt-8 h-15 mx-auto bg-surface-container/50 backdrop-blur-lg p-2 rounded-lg border border-outline-variant/10 shadow-2xl flex flex-col md:flex-row gap-2">
                <input className="bg-transparent border-none focus:ring-0 w-full px-6 text-on-surface text-lg placeholder:text-neutral-600" placeholder="Paste a YouTube link..." />
                <button className="bg-linear-to-br from-primary to-primary-container text-on-primary-container w-[35%]  rounded-md font-bold text-lg hover:brightness-110 transition-all flex justify-center items-center">
                 Start Learning
                </button>
              </div>
